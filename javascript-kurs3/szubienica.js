...
hasla[1] = "Widzisz mnie";
hasla[2] = "Na Na Na Na Na Na";
hasla[3] = "Michał to fajny gość";
hasla[4] = "Skill Issue";
hasla[5] = "Oskar to zjeb nie szanuje go";
hasla[6] = "i am the storm that is approaching";
hasla[7] = "Hello World";

var haslo = hasla[Math.floor(Math.random()*8)];
